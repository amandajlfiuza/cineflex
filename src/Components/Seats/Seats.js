...
function Seat({seat, idsSeats, nameSeats}) {
...
export default function Seats({seats, idsSeats, nameSeats}) {
    return (
        <div className='seats'>
            <div className='layout'>
                {seats.map((seat, index) => (<Seat  key={index} seat={seat} idsSeats={idsSeats} nameSeats={nameSeats} />))}
            </div>
